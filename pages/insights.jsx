          ...
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
              <div className="section-title text-center mb-60 wow fadeInUp delay-0-2s">
                ...
                <p>Stay updated with our latest insights on marketing automation, lead generation, and business growth strategies for high-ticket industries.</p>
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
          ...
          <div className="row align-items-center">
            <div className="col-lg-8">
              <div className="cta-content wow fadeInLeft delay-0-2s">
                <h3>Ready to Build Your Client Acquisition System?</h3>
                <p>Not sure where to begin? Book a discovery call with us and let's discuss how we can help scale your high-ticket business.</p>
              </div>
            </div>
            <div className="col-lg-4 text-lg-end">
              <a href="tel:+254721634183" className="theme-btn wow fadeInRight delay-0-2s">
