// src/components/preview/draft-banner.tsx
      ...
      <div className="flex">
        ...
        <div className="ml-3">
          <p className="text-sm text-yellow-700 dark:text-yellow-200">
            <strong>Preview Mode:</strong> You are viewing draft content from
            branch{" "}
            <code className="font-mono bg-yellow-200 dark:bg-yellow-800 px-1 rounded">
              {branch || "unknown"}
            </code>
          </p>
        </div>
